...
#ifndef POLOPOINTS_CHAIN_PARAMS_H
#define POLOPOINTS_CHAIN_PARAMS_H
#include <memory>
#include "bignum.h"
#include "uint256.h"
 ...
 * Polopoints system. There are three: the main network on which people trade goods
...
public:
	...
	virtual string GetDefaultTestDataPath() const
	{
		...
		#ifdef WIN32
		strCurDir += "\\polopoints_test\\data\\";
		return strCurDir;
		#else
		strCurDir +="/polopoints_test/data/";
		return strCurDir;
