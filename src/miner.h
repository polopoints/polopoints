...
// Copyright (c) 2009-2013 The Polopoints developers
// Copyright (c) 2016 The Polopoints developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef POLOPOINTS_MINER_H
#define POLOPOINTS_MINER_H
...
void GeneratePolopointsBlock(bool fGenerate, CWallet* pwallet, int nThreads);
