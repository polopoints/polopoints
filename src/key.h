...
#ifndef POLOPOINTS_KEY_H
#define POLOPOINTS_KEY_H
...
public:
	...
	unsigned int size() const {
		unsigned int len = GetLen(vch[0]);
		 if(len != 33) //only use 33 for Polopoints sys
			 return 0;
		return len;
	}
 ...
 *  A CTxDestination is the internal data type encoded in a CPolopointsAddress
 */
