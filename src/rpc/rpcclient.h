...
#ifndef _POLOPOINTSRPC_CLIENT_H_
#define _POLOPOINTSRPC_CLIENT_H_ 1
...
/** Show help message for polopoints-cli.
 ...
 *
 * @note the argument can be removed once polopoints-cli functionality is removed from Dacrsd
 */
