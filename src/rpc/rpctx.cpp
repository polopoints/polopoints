...
//						"1. \"address \"  (string, required) The Polopoints address.\n"
//						"\nResult:\n"
//						"\"account info\"  (string) \n"
...
//		CPolopointsAddress address(params[0].get_str());
//		CKeyID keyid;
...
Value validateaddress(const Array& params, bool fHelp)
{
	if(fHelp || params.size() != 1)
		{
			throw runtime_error(
					 "isvalideaddess \"polopoints address\"\n"
					 "\ncheck address is valide\n"
					 "\nArguments:\n"
					 "1. \"polopoints address\"  (string, required) polopoints address\n"
					 "\nResult:\n"
					 "\nExamples:\n"
