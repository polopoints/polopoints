...
#ifndef _POLOPOINTSRPC_SERVER_H_
#define _POLOPOINTSRPC_SERVER_H_ 1
...
/**
 * POLOPOINTS RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern json_spirit::Value getpolopointsstate(const json_spirit::Array& params, bool fHelp);
